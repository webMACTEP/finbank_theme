...
while( $query->have_posts() ){ $query->the_post(); ?>
         <div class="code3text">
             ...
             <div class="w30  td text-center"><div class="hidden-lg">Сумма</div><div class="td-val"><?= number_format(get_field('credit_min_sum'), 0, '.', ' '); ?> - <?= number_format(get_field('credit_max_sum'), 0, '.', ' '); ?> ₽</div></div>
             <div class="td text-center"><div class="hidden-lg">Срок</div><div class="td-val">до <?php $field = get_field('credit_period'); echo $field['label'] ?></div></div>

             <? if(get_field('opisanie_psk_1')): ?>

             <div class="w30  td text-center"><div class="hidden-lg">ПСК</div><div class="td-val"><?php echo the_field('opisanie_psk_1') ?>% - <?php echo the_field('opisanie_psk_2') ?>% </div></div>
